            ...
            <div class="col-md-12 col-12">
                <nav aria-label="breadcrumb" class="page-breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Perfil do Tutor</li>
                    </ol>
                </nav>
                <h2 class="breadcrumb-title">Perfil de {{$user->nome}}</h2>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="doctor-widget">
                    <div class="doc-info-left">
                        <div class="doctor-img">
                            <img src="{{url('assets/img/patients/',$user->foto)}}" class="img-fluid" alt="User Image">
                        </div>
                        <div class="doc-info-cont">
                            <h4 class="doc-name">{{$user->nome}}</h4>
                    ...
                    <div class="doc-info-right">
                        ...
                        <div class="doctor-action">
                            ...
                            <a href="https://tel:{{$user->numero}}" class="btn btn-white call-btn" data-toggle="modal" data-target="#voice_call">
